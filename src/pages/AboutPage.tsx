    ...
    <div className="min-h-screen bg-cyber-dark text-slate-100 font-sans">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 mb-8">
                <a
                  ...
                  className="flex items-start gap-4 rounded-xl border border-white/10 bg-slate-900/40 p-5 hover:border-cyan-400/30 transition-colors group"
                >
                  <div className="bg-cyan-400/10 p-3 rounded-lg border border-cyan-400/20 shrink-0 mt-0.5">
                    <span className="material-symbols-outlined text-cyan-300" style={{ fontSize: '22px' }}>article</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-cyan-300 mb-1">arXiv Publication</p>
                    <p className="text-sm font-bold text-white group-hover:text-cyan-300 transition-colors">Lite VLA: Efficient Vision-Language-Action Control on CPU-Bound Edge Robots</p>
                    <p className="text-xs text-slate-400 mt-1">arXiv:2511.05642 · cs.RO, cs.AR, cs.CV, eess.SY</p>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="bg-cyan-400/10 p-3 rounded-lg border border-cyan-400/20 shrink-0 mt-0.5">
                    <span className="material-symbols-outlined text-cyan-300" style={{ fontSize: '22px' }}>school</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-cyan-300 mb-1">NICE 2026 — Tutorial Presenter</p>
                    <p className="text-sm font-bold text-white group-hover:text-cyan-300 transition-colors">LiteVLA at the Edge: CPU-Only Vision–Language–Action Control as a Testbed for Neuro-Inspired Robotics</p>
                    <p className="text-xs text-slate-400 mt-1">Clark Atlanta University · March 27, 2026</p>
                  </div>
                </a>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 rounded-xl border border-white/10 bg-slate-900/40 text-sm font-bold text-slate-100 hover:border-cyan-400/30 hover:text-cyan-300 transition-all"
                >
      ...
      <section className="py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {highlights.map((item) => (
              <div key={item.title} className="gradient-border rounded-2xl p-8 text-center">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/10 border border-cyan-400/20 mb-6">
                  <span className="material-symbols-outlined text-cyan-300" style={{ fontSize: '28px' }}>{item.icon}</span>
                </div>
          ...
          <div className="max-w-4xl mx-auto glass-dark rounded-2xl p-10 glow-ring">
      ...
      <section className="py-24 bg-white/[0.02] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="space-y-3">
                {principles.map((principle) => (
                  <div key={principle} className="flex items-center gap-3">
                    <span className="material-symbols-outlined text-cyan-300" style={{ fontSize: '18px' }}>check_circle</span>
          ...
          <div className="max-w-4xl mx-auto glass-dark rounded-2xl p-10 glow-ring border-l-4 border-cyan-400/50">
            <blockquote className="text-lg text-slate-400 italic text-center">
