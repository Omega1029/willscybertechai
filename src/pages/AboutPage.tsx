    ...
    <div className="min-h-screen bg-[#0a0a0a] text-slate-100 font-sans">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 mb-8">
                <a
                  ...
                  className="flex items-start gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-5 hover:border-emerald-500/30 transition-colors group"
                >
                  <div className="bg-emerald-900/30 border border-emerald-700/20 p-3 rounded-lg shrink-0 mt-0.5">
                    <span className="material-symbols-outlined text-emerald-400" style={{ fontSize: '22px' }}>article</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-1">arXiv Publication</p>
                    <p className="text-sm font-bold text-white group-hover:text-emerald-400 transition-colors">Lite VLA: Efficient Vision-Language-Action Control on CPU-Bound Edge Robots</p>
                ...
                >
                  <div className="bg-emerald-900/30 border border-emerald-700/20 p-3 rounded-lg shrink-0 mt-0.5">
                    <span className="material-symbols-outlined text-emerald-400" style={{ fontSize: '22px' }}>school</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-1">NICE 2026 — Tutorial Presenter</p>
                    <p className="text-sm font-bold text-white group-hover:text-emerald-400 transition-colors">LiteVLA at the Edge: CPU-Only Vision–Language–Action Control as a Testbed for Neuro-Inspired Robotics</p>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 rounded-xl border border-zinc-800 bg-zinc-900 text-sm font-bold text-slate-100 hover:border-emerald-500/30 hover:text-emerald-400 transition-all"
                >
            ...
            {highlights.map((item) => (
              <div key={item.title} className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 text-center">
                <div className="bg-emerald-900/30 border border-emerald-700/20 p-2.5 rounded-lg inline-flex mb-6">
                  <span className="material-symbols-outlined text-emerald-400" style={{ fontSize: '28px' }}>{item.icon}</span>
                </div>
      ...
      <section className="py-24 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="max-w-4xl mx-auto bg-zinc-900 border border-zinc-800 rounded-xl p-10 border-l-4 border-l-emerald-500">
