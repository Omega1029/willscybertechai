    ...
    <div className="min-h-screen bg-[#0a0a0a] text-slate-100">
      ...
      <div className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-blue-900/30 border border-blue-700/20 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 text-left hover:border-blue-700/40 transition-colors">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-900/30 border border-blue-700/20 mb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-blue-500 hover:bg-blue-400 text-black rounded-xl font-semibold text-lg transition-colors mt-10"
          >
            <Sparkles size={24} />
            Launch AI Agent
