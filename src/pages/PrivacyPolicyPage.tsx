...
const PrivacyPolicyPage = () => {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero */}
      <section className="hero-gradient border-b border-blue-100 py-20">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <h1 className="text-headline-xl text-on-surface mb-4">Privacy Policy</h1>
      ...
      <section className="py-20 bg-surface-container-lowest">
        <div className="max-w-3xl mx-auto px-8">
          <div className="bg-white border border-blue-100 rounded-2xl shadow-sm p-10 space-y-10">
            ...
            <div>
              <h2 className="text-headline-sm text-on-surface mb-4">3. Data Storage and Security</h2>
              <p className="text-on-surface-variant text-body-md leading-relaxed">
            ...
            <div>
              <h2 className="text-headline-sm text-on-surface mb-4">4. Third-Party Services and Disclosure</h2>
              <p className="text-on-surface-variant text-body-md leading-relaxed">
            ...
            <div>
              <h2 className="text-headline-sm text-on-surface mb-4">5. Your Rights and Contact</h2>
              <p className="text-on-surface-variant text-body-md leading-relaxed">
                ...
                <a href="mailto:willscybertech@gmail.com" className="text-primary-container hover:underline font-medium">
